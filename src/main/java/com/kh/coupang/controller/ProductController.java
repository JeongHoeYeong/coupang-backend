...
public class ProductController {
    ...
    @GetMapping("/product")
    public ResponseEntity<List<Product>> viewAll(@RequestParam(name="category", required = false)
                                                Integer category, @RequestParam(name="page", defaultValue = "1") int page) {
        ...
        // 5. BoleanBuilder는 QuerydslPredicateExcutor 인터페이스의 finAll() 사용
    ...
    public ResponseEntity<Product> view(@PathVariable("code") int code) {
        Product result = product.view(code);
